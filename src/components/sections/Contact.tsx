            ...
            <div className="relative rounded-2xl p-6 shadow-sm border border-gray-100 h-full flex flex-col overflow-hidden" style={{ backgroundImage: "url('/pics/ambulance/pics.jpg')", backgroundSize: '100%', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="space-y-5 flex-1 flex flex-col justify-center">
                  <a href={generateCallLink(COMPANY.phone[0])} className="flex items-center gap-4 group justify-center" style={{ marginBottom: '11px' }}><div className="w-12 h-12 bg-medical-red/20 rounded-xl flex items-center justify-center group-hover:bg-medical-red/30 transition-all shrink-0"><Phone className="w-5 h-5 text-medical-red" /></div><div><div className="text-base font-bold text-medical-red">Phone</div><div className="font-bold text-deep-navy text-sm">{COMPANY.phone[0]}</div></div></a>
                  <a href={generateWhatsAppLink(COMPANY.whatsapp[0])} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group justify-center" style={{ marginBottom: '11px' }}><div className="w-12 h-12 bg-green-500/20 rounded-xl flex items-center justify-center group-hover:bg-green-500/30 transition-all shrink-0"><MessageCircle className="w-5 h-5 text-green-600" /></div><div><div className="text-base font-bold text-medical-red">WhatsApp</div><div className="font-bold text-deep-navy text-sm">{COMPANY.whatsapp[0]}</div></div></a>
